...
public class SmiDefinedValueImpl extends SmiValueImpl implements SmiDefinedValue {

  public SmiDefinedValueImpl(ASTNode node) {
    super(node);
  }
  ...
  public SmiDefinedValueName getDefinedValueName() {
    return findNotNullChildByClass(SmiDefinedValueName.class);
  }
