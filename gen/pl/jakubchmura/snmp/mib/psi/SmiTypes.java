...
public interface SmiTypes {
  ...
  IElementType ALPHABET_CONSTRAINT = new SmiElementType("ALPHABET_CONSTRAINT");
  IElementType ANY_TYPE = new SmiElementType("ANY_TYPE");
  IElementType ASSIGNMENT = new SmiElementType("ASSIGNMENT");
  IElementType BINARY_VALUE = new SmiElementType("BINARY_VALUE");
  IElementType BITS_TYPE = new SmiElementType("BITS_TYPE");
  IElementType BIT_OR_OBJECT_IDENTIFIER_VALUE = new SmiElementType("BIT_OR_OBJECT_IDENTIFIER_VALUE");
  IElementType BIT_STRING_TYPE = new SmiElementType("BIT_STRING_TYPE");
  IElementType BOOLEAN_TYPE = new SmiElementType("BOOLEAN_TYPE");
  IElementType BOOLEAN_VALUE = new SmiElementType("BOOLEAN_VALUE");
  ...
  IElementType CLASS_TYPE = new SmiElementType("CLASS_TYPE");
  IElementType COMPLIANCE_GROUP = new SmiElementType("COMPLIANCE_GROUP");
  IElementType COMPLIANCE_OBJECT = new SmiElementType("COMPLIANCE_OBJECT");
  IElementType COMPONENTS_LIST = new SmiElementType("COMPONENTS_LIST");
  IElementType COMPONENTS_LIST_TAIL = new SmiElementType("COMPONENTS_LIST_TAIL");
  IElementType COMPONENT_CONSTRAINT = new SmiElementType("COMPONENT_CONSTRAINT");
  IElementType COMPONENT_PRESENCE = new SmiElementType("COMPONENT_PRESENCE");
  IElementType COMPONENT_VALUE_PRESENCE = new SmiElementType("COMPONENT_VALUE_PRESENCE");
  IElementType CONSTRAINT = new SmiElementType("CONSTRAINT");
  IElementType CONTAINED_TYPE_CONSTRAINT = new SmiElementType("CONTAINED_TYPE_CONSTRAINT");
  IElementType DEFINED_MACRO_NAME = new SmiElementType("DEFINED_MACRO_NAME");
  ...
  IElementType DEFINED_VALUE = new SmiElementType("DEFINED_VALUE");
  ...
  IElementType ENUMERATED_TYPE = new SmiElementType("ENUMERATED_TYPE");
  IElementType EXPLICIT_OR_IMPLICIT_TAG = new SmiElementType("EXPLICIT_OR_IMPLICIT_TAG");
  IElementType EXPORT_LIST = new SmiElementType("EXPORT_LIST");
  IElementType HEXADECIMAL_VALUE = new SmiElementType("HEXADECIMAL_VALUE");
  ...
  IElementType INNER_TYPE_CONSTRAINT = new SmiElementType("INNER_TYPE_CONSTRAINT");
  IElementType INTEGER_TYPE = new SmiElementType("INTEGER_TYPE");
  IElementType LOWER_END_POINT = new SmiElementType("LOWER_END_POINT");
  IElementType MACRO_BODY = new SmiElementType("MACRO_BODY");
  IElementType MACRO_BODY_ELEMENT = new SmiElementType("MACRO_BODY_ELEMENT");
  IElementType MACRO_DEFINITION = new SmiElementType("MACRO_DEFINITION");
  IElementType MACRO_REFERENCE = new SmiElementType("MACRO_REFERENCE");
  IElementType MIB_NODE = new SmiElementType("MIB_NODE");
  IElementType MODULE_BODY = new SmiElementType("MODULE_BODY");
  ...
  IElementType NUMBER_VALUE = new SmiElementType("NUMBER_VALUE");
  IElementType OBJECT_IDENTIFIER_TYPE = new SmiElementType("OBJECT_IDENTIFIER_TYPE");
  IElementType OBJECT_IDENTIFIER_VALUE = new SmiElementType("OBJECT_IDENTIFIER_VALUE");
  IElementType OPTIONAL_OR_DEFAULT_ELEMENT = new SmiElementType("OPTIONAL_OR_DEFAULT_ELEMENT");
  IElementType REAL_TYPE = new SmiElementType("REAL_TYPE");
  IElementType SELECTION_TYPE = new SmiElementType("SELECTION_TYPE");
  ...
  IElementType SET_OF_TYPE = new SmiElementType("SET_OF_TYPE");
  IElementType SET_TYPE = new SmiElementType("SET_TYPE");
  IElementType SIZE_CONSTRAINT = new SmiElementType("SIZE_CONSTRAINT");
  IElementType SNMP_ACCESS_PART = new SmiElementType("SNMP_ACCESS_PART");
  IElementType SNMP_AGENT_CAPABILITIES_MACRO_TYPE = new SmiElementType("SNMP_AGENT_CAPABILITIES_MACRO_TYPE");
  IElementType SNMP_COMPLIANCE_PART = new SmiElementType("SNMP_COMPLIANCE_PART");
  IElementType SNMP_CONTACT_PART = new SmiElementType("SNMP_CONTACT_PART");
  IElementType SNMP_CREATION_PART = new SmiElementType("SNMP_CREATION_PART");
  IElementType SNMP_DEF_VAL_PART = new SmiElementType("SNMP_DEF_VAL_PART");
  IElementType SNMP_DESCR_PART = new SmiElementType("SNMP_DESCR_PART");
  IElementType SNMP_DISPLAY_PART = new SmiElementType("SNMP_DISPLAY_PART");
  IElementType SNMP_ENTERPRISE_PART = new SmiElementType("SNMP_ENTERPRISE_PART");
  IElementType SNMP_INDEX_PART = new SmiElementType("SNMP_INDEX_PART");
  IElementType SNMP_MANDATORY_PART = new SmiElementType("SNMP_MANDATORY_PART");
  ...
  IElementType SNMP_MODULE_IMPORT = new SmiElementType("SNMP_MODULE_IMPORT");
  IElementType SNMP_MODULE_PART = new SmiElementType("SNMP_MODULE_PART");
  IElementType SNMP_MODULE_SUPPORT_PART = new SmiElementType("SNMP_MODULE_SUPPORT_PART");
  IElementType SNMP_NOTIFICATIONS_PART = new SmiElementType("SNMP_NOTIFICATIONS_PART");
  ...
  IElementType SNMP_OBJECTS_PART = new SmiElementType("SNMP_OBJECTS_PART");
  ...
  IElementType SNMP_ORGANIZATION_PART = new SmiElementType("SNMP_ORGANIZATION_PART");
  IElementType SNMP_PRODUCT_RELEASE_PART = new SmiElementType("SNMP_PRODUCT_RELEASE_PART");
  IElementType SNMP_REFER_PART = new SmiElementType("SNMP_REFER_PART");
  IElementType SNMP_REVISION_PART = new SmiElementType("SNMP_REVISION_PART");
  IElementType SNMP_STATUS_PART = new SmiElementType("SNMP_STATUS_PART");
  IElementType SNMP_SYNTAX_PART = new SmiElementType("SNMP_SYNTAX_PART");
  ...
  IElementType SNMP_UNITS_PART = new SmiElementType("SNMP_UNITS_PART");
  IElementType SNMP_UPDATE_PART = new SmiElementType("SNMP_UPDATE_PART");
  IElementType SNMP_VARIATION_PART = new SmiElementType("SNMP_VARIATION_PART");
  IElementType SNMP_VAR_PART = new SmiElementType("SNMP_VAR_PART");
  IElementType SNMP_WRITE_SYNTAX_PART = new SmiElementType("SNMP_WRITE_SYNTAX_PART");
  IElementType SPECIAL_REAL_VALUE = new SmiElementType("SPECIAL_REAL_VALUE");
  IElementType STRING_TYPE = new SmiElementType("STRING_TYPE");
  IElementType STRING_VALUE = new SmiElementType("STRING_VALUE");
  ...
  IElementType TAG = new SmiElementType("TAG");
  IElementType TAGGED_TYPE = new SmiElementType("TAGGED_TYPE");
  IElementType TAG_DEFAULT = new SmiElementType("TAG_DEFAULT");
  ...
  IElementType UPPER_END_POINT = new SmiElementType("UPPER_END_POINT");
  IElementType VALUE = new SmiElementType("VALUE");
  IElementType VALUE_ASSIGNMENT = new SmiElementType("VALUE_ASSIGNMENT");
  IElementType VALUE_CONSTRAINT = new SmiElementType("VALUE_CONSTRAINT");
  IElementType VALUE_OR_CONSTRAINT_LIST = new SmiElementType("VALUE_OR_CONSTRAINT_LIST");
  IElementType VALUE_RANGE = new SmiElementType("VALUE_RANGE");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      IElementType type = node.getElementType();
       if (type == ALPHABET_CONSTRAINT) {
        return new SmiAlphabetConstraintImpl(node);
      }
      else if (type == ANY_TYPE) {
        return new SmiAnyTypeImpl(node);
      }
      else if (type == ASSIGNMENT) {
        return new SmiAssignmentImpl(node);
      }
      else if (type == BINARY_VALUE) {
        return new SmiBinaryValueImpl(node);
      }
      else if (type == BITS_TYPE) {
        return new SmiBitsTypeImpl(node);
      }
      else if (type == BIT_OR_OBJECT_IDENTIFIER_VALUE) {
        return new SmiBitOrObjectIdentifierValueImpl(node);
      }
      else if (type == BIT_STRING_TYPE) {
        return new SmiBitStringTypeImpl(node);
      }
      else if (type == BOOLEAN_TYPE) {
        return new SmiBooleanTypeImpl(node);
      }
      else if (type == BOOLEAN_VALUE) {
        return new SmiBooleanValueImpl(node);
      }
      else if (type == CHOICE_TYPE) {
        return new SmiChoiceTypeImpl(node);
      }
      else if (type == CLASS_TYPE) {
        return new SmiClassTypeImpl(node);
      }
      else if (type == COMPLIANCE_GROUP) {
        return new SmiComplianceGroupImpl(node);
      }
      else if (type == COMPLIANCE_OBJECT) {
        return new SmiComplianceObjectImpl(node);
      }
      else if (type == COMPONENTS_LIST) {
        return new SmiComponentsListImpl(node);
      }
      else if (type == COMPONENTS_LIST_TAIL) {
        return new SmiComponentsListTailImpl(node);
      }
      else if (type == COMPONENT_CONSTRAINT) {
        return new SmiComponentConstraintImpl(node);
      }
      else if (type == COMPONENT_PRESENCE) {
        return new SmiComponentPresenceImpl(node);
      }
      else if (type == COMPONENT_VALUE_PRESENCE) {
        return new SmiComponentValuePresenceImpl(node);
      }
      else if (type == CONSTRAINT) {
        return new SmiConstraintImpl(node);
      }
      else if (type == CONTAINED_TYPE_CONSTRAINT) {
        return new SmiContainedTypeConstraintImpl(node);
      }
      else if (type == DEFINED_MACRO_NAME) {
        return new SmiDefinedMacroNameImpl(node);
      }
      ...
      else if (type == DEFINED_VALUE) {
        return new SmiDefinedValueImpl(node);
      }
      ...
      else if (type == ENUMERATED_TYPE) {
        return new SmiEnumeratedTypeImpl(node);
      }
      else if (type == EXPLICIT_OR_IMPLICIT_TAG) {
        return new SmiExplicitOrImplicitTagImpl(node);
      }
      else if (type == EXPORT_LIST) {
        return new SmiExportListImpl(node);
      }
      else if (type == HEXADECIMAL_VALUE) {
        return new SmiHexadecimalValueImpl(node);
      }
      ...
      else if (type == INNER_TYPE_CONSTRAINT) {
        return new SmiInnerTypeConstraintImpl(node);
      }
      else if (type == INTEGER_TYPE) {
        return new SmiIntegerTypeImpl(node);
      }
      else if (type == LOWER_END_POINT) {
        return new SmiLowerEndPointImpl(node);
      }
      else if (type == MACRO_BODY) {
        return new SmiMacroBodyImpl(node);
      }
      else if (type == MACRO_BODY_ELEMENT) {
        return new SmiMacroBodyElementImpl(node);
      }
      else if (type == MACRO_DEFINITION) {
        return new SmiMacroDefinitionImpl(node);
      }
      else if (type == MACRO_REFERENCE) {
        return new SmiMacroReferenceImpl(node);
      }
      else if (type == MIB_NODE) {
        return new SmiMibNodeImpl(node);
      }
      else if (type == MODULE_BODY) {
        return new SmiModuleBodyImpl(node);
      }
        ...
        return new SmiNullTypeImpl(node);
      }
      else if (type == NULL_VALUE) {
        return new SmiNullValueImpl(node);
      }
      else if (type == NUMBER) {
        return new SmiNumberImpl(node);
      }
      else if (type == NUMBER_VALUE) {
        return new SmiNumberValueImpl(node);
      }
      else if (type == OBJECT_IDENTIFIER_TYPE) {
        return new SmiObjectIdentifierTypeImpl(node);
      }
      else if (type == OBJECT_IDENTIFIER_VALUE) {
        return new SmiObjectIdentifierValueImpl(node);
      }
      else if (type == OPTIONAL_OR_DEFAULT_ELEMENT) {
        return new SmiOptionalOrDefaultElementImpl(node);
      }
      else if (type == REAL_TYPE) {
        return new SmiRealTypeImpl(node);
      }
      else if (type == SELECTION_TYPE) {
        return new SmiSelectionTypeImpl(node);
      }
      ...
      else if (type == SET_OF_TYPE) {
        return new SmiSetOfTypeImpl(node);
      }
      else if (type == SET_TYPE) {
        return new SmiSetTypeImpl(node);
      }
      else if (type == SIZE_CONSTRAINT) {
        return new SmiSizeConstraintImpl(node);
      }
      else if (type == SNMP_ACCESS_PART) {
        return new SmiSnmpAccessPartImpl(node);
      }
      else if (type == SNMP_AGENT_CAPABILITIES_MACRO_TYPE) {
        return new SmiSnmpAgentCapabilitiesMacroTypeImpl(node);
      }
      else if (type == SNMP_COMPLIANCE_PART) {
        return new SmiSnmpCompliancePartImpl(node);
      }
      else if (type == SNMP_CONTACT_PART) {
        return new SmiSnmpContactPartImpl(node);
      }
      else if (type == SNMP_CREATION_PART) {
        return new SmiSnmpCreationPartImpl(node);
      }
      ...
      else if (type == SNMP_DISPLAY_PART) {
        return new SmiSnmpDisplayPartImpl(node);
      }
      ...
      else if (type == SNMP_MANDATORY_PART) {
        return new SmiSnmpMandatoryPartImpl(node);
      }
      ...
      else if (type == SNMP_MODULE_IMPORT) {
        return new SmiSnmpModuleImportImpl(node);
      }
      else if (type == SNMP_MODULE_PART) {
        return new SmiSnmpModulePartImpl(node);
      }
      else if (type == SNMP_MODULE_SUPPORT_PART) {
        return new SmiSnmpModuleSupportPartImpl(node);
      }
      else if (type == SNMP_NOTIFICATIONS_PART) {
        return new SmiSnmpNotificationsPartImpl(node);
      }
      ...
      else if (type == SNMP_ORGANIZATION_PART) {
        return new SmiSnmpOrganizationPartImpl(node);
      }
      else if (type == SNMP_PRODUCT_RELEASE_PART) {
        return new SmiSnmpProductReleasePartImpl(node);
      }
      else if (type == SNMP_REFER_PART) {
        return new SmiSnmpReferPartImpl(node);
      }
      else if (type == SNMP_REVISION_PART) {
        return new SmiSnmpRevisionPartImpl(node);
      }
      else if (type == SNMP_STATUS_PART) {
        return new SmiSnmpStatusPartImpl(node);
      }
      ...
      else if (type == SNMP_UNITS_PART) {
        return new SmiSnmpUnitsPartImpl(node);
      }
      else if (type == SNMP_UPDATE_PART) {
        return new SmiSnmpUpdatePartImpl(node);
      }
      else if (type == SNMP_VARIATION_PART) {
        return new SmiSnmpVariationPartImpl(node);
      }
      else if (type == SNMP_VAR_PART) {
        return new SmiSnmpVarPartImpl(node);
      }
      else if (type == SNMP_WRITE_SYNTAX_PART) {
        return new SmiSnmpWriteSyntaxPartImpl(node);
      }
      else if (type == SPECIAL_REAL_VALUE) {
        return new SmiSpecialRealValueImpl(node);
      }
      else if (type == STRING_TYPE) {
        return new SmiStringTypeImpl(node);
      }
      else if (type == STRING_VALUE) {
        return new SmiStringValueImpl(node);
      }
      else if (type == SYMBOL) {
        ...
        return new SmiTagImpl(node);
      }
      else if (type == TAGGED_TYPE) {
        return new SmiTaggedTypeImpl(node);
      }
      else if (type == TAG_DEFAULT) {
        return new SmiTagDefaultImpl(node);
      }
      else if (type == TYPE) {
      ...
      else if (type == UPPER_END_POINT) {
        return new SmiUpperEndPointImpl(node);
      }
      else if (type == VALUE_ASSIGNMENT) {
        return new SmiValueAssignmentImpl(node);
      }
      else if (type == VALUE_CONSTRAINT) {
        return new SmiValueConstraintImpl(node);
      }
      else if (type == VALUE_OR_CONSTRAINT_LIST) {
        return new SmiValueOrConstraintListImpl(node);
      }
      else if (type == VALUE_RANGE) {
        return new SmiValueRangeImpl(node);
      }
